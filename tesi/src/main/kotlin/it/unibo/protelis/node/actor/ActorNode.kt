package it.unibo.protelis.node.actor
...
import it.unibo.protelis.node.DestinationNode
import it.unibo.protelis.node.GenericNode
...
object ActorNodeFactory {
    ...
    private val actorSystem by lazy { ActorSystem.create(actorSystemName, localConf) }
    ...
    fun createDestinationNode(protelisProgram: ProtelisProgram, sleepTime: Long, mqttAddress: String, applicationUID: String,
        ...
        createActorWithNode(DestinationNode(protelisProgram, sleepTime, destinationUID, applicationUID, mqttAddress, position))
    ...
    fun createSensorNode(protelisProgram: ProtelisProgram, sleepTime: Long, mqttAddress: String, applicationUID: String,
        ...
        createActorWithNode(SensorNode(protelisProgram, sleepTime, sensorDeviceUID, applicationUID, mqttAddress, position, sensorTypes))
    ...
    fun createUserNode(protelisProgram: ProtelisProgram, sleepTime: Long, mqttAddress: String, applicationUID: String,
        ...
        createActorWithNode(UserNode(protelisProgram, sleepTime, userUID, applicationUID, mqttAddress, position, sensorTypes))
