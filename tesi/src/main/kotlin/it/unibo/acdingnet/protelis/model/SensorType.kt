...
enum class SensorType(val length: Int = 1, val levels: List<Pair<Int, Int>> = emptyList(), private val converter: SensorConverter = DefaultConverter()) {
    ...
    fun convertToDouble(data: MutableList<Byte>): Double = converter.convert(length, data)
